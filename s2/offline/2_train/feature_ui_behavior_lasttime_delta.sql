...
drop table if exists offline_train_feature_ui_behavior_lasttime_delta;
create table offline_train_feature_ui_behavior_lasttime_delta
 ...
 -- ui
	...
	left outer join
	(
	select user_id, item_id, datediff("2014-12-17 00:00:00", to_date(max(time),"yyyy-mm-dd hh"), "dd") as f3_5
	from offline_raw_train_set
...
-- ui + f5
	...
	left outer join
	(
	select user_id, item_id, datediff("2014-12-17 00:00:00", to_date(max(time),"yyyy-mm-dd hh"), "dd") as f3_6
	from offline_raw_train_set
...
-- ui + f5 + f6
	...
	left outer join
	(
	select user_id, item_id, datediff("2014-12-17 00:00:00", to_date(max(time),"yyyy-mm-dd hh"), "dd") as f3_7
	from offline_raw_train_set
...
-- ui + f5 + f6 + f7
	...
	left outer join
	(
	select user_id, item_id, datediff("2014-12-17 00:00:00", to_date(max(time),"yyyy-mm-dd hh"), "dd") as f3_8
	from offline_raw_train_set

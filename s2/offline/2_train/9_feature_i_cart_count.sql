...
drop table if exists offline_train_feature_i_cart_count;
create table offline_train_feature_i_cart_count
 ...
 -- ui
	...
	from offline_raw_train_set
	where behavior_type=3 and time>="2014-12-14 00" and time<"2014-12-17 00" -- p3
	group by item_id
	) b
 ...
 -- ui + f1_1_3
	...
	from offline_raw_train_set
	where behavior_type=3 and time>="2014-12-10 00" and time<"2014-12-17 00" -- p7
	group by item_id
	) c

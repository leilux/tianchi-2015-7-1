...
create table offline_test_set
    ...
    from
		...
		offline_test_feature_ui_behavior_count a

		left outer join
		offline_test_feature_ui_behavior_lasttime_delta b
		on a.user_id=b.user_id and a.item_id=b.item_id

		left outer join
		offline_test_feature_u_behavior_count c
		on a.user_id=c.user_id and a.item_id=c.item_id

		left outer join
		offline_test_feature_i_sale_count d

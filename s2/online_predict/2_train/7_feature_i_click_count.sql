...
drop table if exists online_train_feature_i_click_count;
create table online_train_feature_i_click_count
 ...
 -- ui
	...
	from online_raw_train_set
	where behavior_type=1 and time>="2014-12-15 00" and time<"2014-12-18 00" -- p3
	group by item_id
	) b
 ...
 -- ui + f1_1_3
	...
	from online_raw_train_set
	where behavior_type=1 and time>="2014-12-11 00" and time<"2014-12-18 00" -- p7
	group by item_id
	) c

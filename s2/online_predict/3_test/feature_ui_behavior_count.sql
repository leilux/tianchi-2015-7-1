...
-- f3_1, f3_2, f3_3, f3_4
drop table if exists online_test_feature_ui_behavior_count;
create table online_test_feature_ui_behavior_count
    -- as select a.user_id, a.item_id, IfNULL(b.f3_1, 0), IfNULL(c.f3_2, 0), IfNULL(d.f3_3, 0), IfNULL(e.f3_4, 0)

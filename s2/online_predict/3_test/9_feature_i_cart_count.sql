...
drop table if exists online_test_feature_i_cart_count;
create table online_test_feature_i_cart_count
 ...
 -- ui
	...
	from online_raw_test_set
	where behavior_type=3 and time>="2014-12-16 00" and time<"2014-12-19 00" -- p3
	group by item_id
	) b
 ...
 -- ui + f1_1_3
	...
	from online_raw_test_set
	where behavior_type=3 and time>="2014-12-12 00" and time<"2014-12-19 00" -- p7
	group by item_id
	) c
